 ...
 */
package cn.peterzhen.zxing.camera;
 ...
 */
public final class CameraConfigurationManager2 {
    ...
    public CameraConfigurationManager2(Context context) {
    ...
    public void initFromCameraParameters(Camera camera) {
        ...
        Camera.Size cameraSize = findCloselySize(displayMetrics.widthPixels, displayMetrics.heightPixels,
                parameters.getSupportedPreviewSizes());
        cameraResolution = new Point(cameraSize.width,cameraSize.height);
        Camera.Size screenSize = findCloselySize(displayMetrics.widthPixels, displayMetrics.heightPixels,
                parameters.getSupportedPictureSizes());
        screenResolution = new Point(screenSize.width,screenSize.height);
    }
